...
%\address{\href{mailto:ywang00149@gmail.com}{ywang00149@gmail.com} \\ +1(929)624-1021 \\ \href{http://cosmotim.github.io}{Portfolio Website} \\ \href{http://linkedin.com/in/tim-wang-yitian/}{Linkedin}} % Your phone number and email
\begin{document}
...
\href{http://linkedin.com/in/tim-wang-yitian/}{LinkedIn}
\end{minipage}
\vspace{0.5em}
...
Thermal-sciences researcher with a Ph.D. in Electrical and Computer Engineering and expertise in heat transfer, thermodynamics, thermal transport, and electrochemistry for solid-state energy materials.
Experienced in designing and executing experimental programs, developing instrumentation and data-reduction workflows, and applying analytical and numerical modeling using Python, MATLAB, and COMSOL.
Published 6 first-author and 3 co-authored peer-reviewed journal articles; experienced in national-laboratory collaboration, technical proposals, and communicating results to cross-disciplinary research teams.
\end{rSection}
...
{\bf University of California, Riverside, CA}\hfill{Mar.\ 2021 -- Jun.\ 2026}
...
Thermal Sciences \& Modeling & Heat Transfer, Thermodynamics, Thermal Transport, Python, MATLAB, COMSOL, SolidWorks \\[4pt]
Software & R, SQL, LaTeX, Linux \\[4pt]
...
\begin{rSubsection}
{Postdoctoral Fellow}{Jul.\ 2026 -- Present}
...
\item Designed and executed thermal-transport experiments on Li-ion solid-state electrolytes, extending lattice-dynamics studies previously limited to Cu- and Ag-ion systems.
\item Published 6 first-author papers in journals including \textit{Applied Physics Reviews}, \textit{PRX Energy}, and \textit{J.\ Mater.\ Chem.\ A}.
\item Developed a floating-zone crystal-growth workflow and experimental specimens, producing centimeter-scale LLZTO single crystals for phonon-resolved neutron-scattering measurements.
...
\item Built automated data-acquisition reduction and analysis pipelines in Mantid and Python, improving reproducibility and reducing manual analysis time.
\item Led on-site experimental decisions and coordinated a multi-institutional team spanning $\sim$7 research groups at UCR, UT Austin, ORNL, ETH Z\"{u}rich, and TU Wien.
\end{rSubsection}
...
Technology in the Premodern World (ENGR 108) & Teaching Assistant & Spring 2025 & \textit{5.7/7.0 (83rd \%ile)} \\
Linear Methods for Engr.\ Analysis -- MATLAB (EE 020B) & Teaching Assistant & Winter 2023 & \textit{6.5/7.0 (81st \%ile)} \\
Magnetic Materials (EE 139) & Teaching Assistant & Fall 2022 & \textit{6.5/7.0 (77th \%ile)} \\
\end{tabular}
\vspace{0.3em}
...
\item \textbf{Y. Wang}, H. Wang, X. Chen.
``Thermal transport mechanisms in electrolytes for all-solid-state batteries.''
\textit{Appl.\ Phys.\ Rev.}, Sep.\ 2026.
\href{https://doi.org/10.1063/5.0318328}{[Link]}
