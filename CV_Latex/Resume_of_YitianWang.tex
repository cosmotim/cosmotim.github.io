...
Software    & Python, MATLAB, R, SQL, LaTeX, COMSOL, SolidWorks, Linux \\[4pt]
            & GSAS-II, Mantid, ImageJ, VESTA, Quantum ESPRESSO, VASP \\[4pt]
Synthesis   & Floating-Zone Crystal Growth, PVD / Magnetron Sputtering, CVD \\[4pt]
Characterization    & SEM, TEM, STM, XRD, AFM, Inelastic Neutron Scattering, Raman, FTIR \\[4pt]
                    & PPMS, DSC, TGA, Four-Probe Method, Tensile Strength Testing \\[4pt]
Battery             & Prototype Cell Assembly, Separator Fabrication, EIS, Galvanostatic Cycling, Thermal Abuse Testing \\[4pt]
...
\item MRS Spring Meeting Highly Commended Student Talk Award, Materials Research Society (2023)
\item Columbia University GSA Python Coding Contest — Awarded Individual (2020)
\item JINGSHI Scholarship, Beijing Normal University (2016 -- 2018)
\item COMAP Mathematical Contest in Modeling — Team leader (2017)
\end{itemize}
\end{rSection}
