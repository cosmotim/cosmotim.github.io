...
\address{ywang1057@ucr.edu \\ \href{http://cosmotim.github.io}{http://cosmotim.github.io} \\ \href{http://linkedin.com/in/tim-wang-yitian/}{http://linkedin.com/in/tim-wang-yitian/}} % Your phone number and email
...
\begin{rSubsection}
    ...
    {University of California}{Riverside, CA}
\item Grew samples with floating zone method using an image furnace.
\item Studied the transport properties of complex oxide ionic conductors.
\end{rSubsection}

\begin{rSubsection}
    {Inelastic neutron scattering on LLZTO single crystal}{\em Jan. 2022 - Jul. 2023}
    {Oak Ridge National Laboratory}{Oak Ridge, TN}
    \item Conducted neutron scattering experiments using TAX and ARCS.
...
\begin{rSubsection}
    ...
    {University of California}{Riverside, CA}
\item Developed an expandable fitting model using MatLab.
\end{rSubsection}

\begin{rSubsection}
{Advanced separator of lithium-ion battery}{\em Oct. 2019 - Jan. 2021}
{Columbia University}{New York, NY}
 \item Made a series of composite battery separators with $\gamma-C_3 N_4$ and PVDF.
 \item Assembled full cell batteries and tested their electrochemical properties.
\end{rSubsection}

\begin{rSubsection}
{First-principles calculation of olivine structure }{\em Sep. 2019 - Jan. 2020}
{Columbia University}{New York, NY}
\item Used Quantum ESPRESSO to calculate the structure with hydrogen defects.
\end{rSubsection}
...
{Low temperature uniaxial strain device}{\em Sep. 2018 - May 2019}
{Beijing Normal University}{Beijing, CN}
\item Modeled devices in SolidWorks to apply pressure utilizing thermal expansion.
...
\item \href{https://doi.org/10.1039/D5CC04693A}{Glass-like thermal transport in polycrystalline perovskite lithium-ion conductor \\ Li$_{3/8}$Sr$_{7/16}$Hf$_{1/4}$Ta$_{3/4}$O$_3$}
    \begin{itemize}
        \item \textit{Chemical Communications}, 2025
...
\item \href{https://doi.org/10.1007/s42864-025-00357-6}{Low Thermal Conductivity and Lattice Anharmonicity of NaSICON-type Solid Electrolyte \\ Na$_3$Zr$_2$Si$_2$PO$_{12}$}
    \begin{itemize}
        \item \textit{Tungsten}, 2025 (Accepted)
        \item \textbf{Y. Wang}, Q. Jia, S. Li, L. Shi, Y. Li, X. Chen
    \end{itemize}
...
\item \href{https://doi.org/10.1039/D4TA02264E}{Thermal properties and lattice anharmonicity of Li-ion conducting garnet solid electrolyte \\ Li$_{6.5}$La$_3$Zr$_{1.5}$Ta$_{0.5}$O$_{12}$}
    \begin{itemize}
        \item \textit{Journal of Materials Chemistry A}, 2024
...
\item \href{https://doi.org/10.1063/5.0214897}{Enhanced magnon thermal transport in yttrium-doped spin ladder compounds Sr$_{14-x}$Y$_x$Cu$_{24}$O$_{41}$}
    \begin{itemize}
        \item \textit{Journal of Applied Physics}, 2024
...
\item \href{https://doi.org/10.1016/j.xcrp.2024.101879}{Size-dependent magnon thermal transport in a nanostructured quantum magnet}
    \begin{itemize}
        \item \textit{Cell Reports Physical Science}, 2024
...
\item \href{https://doi.org/10.1021/acs.chemmater.2c02155}{Crystal structure and thermoelectric properties of layered van der Waals semimetal ZrTiSe$_4$}
    \begin{itemize}
        \item \textit{Chemistry of Materials}, 2022
